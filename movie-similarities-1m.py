...
#per executer should have 1g and  thats we left emty in spark config default is 512 mb
#spark-submit --executor-memory 1g MovieSimilarities1M.py 260(movie id whose similarities we needed)
